'''
Contains separate classes of each network architecture
- The specified classes will be called upon initialising a new instance of a neural network
- Using CrowdCounter(architecture)
'''
